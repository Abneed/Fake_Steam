...
INSERT INTO JUEGOS(NOMBRE,FECHALANZAMIENTO,IDDESARROLLADORES,IDCLASIFICACION,IDDISTRIBUIDOR,PRECIO)
VALUES(@NOMBRE,@FECHALANZAMIENTO,@IDDESARROLLADOR,@IDCLASIFICACION,@IDDISTRIBUIDOR,@PRECIO)
----------------------------------VALIDACION---------------------------------------------------------------------------
