...
{
    public partial class FormAdministradorUsuarios : Form
    {

        private string imgLoc = "C:\\Users\\Angel\\Pictures\\Usuario.jpg";
        ConexionBD connFakeSteamBD = new ConexionBD();
        FormPrincipal miprincipal = new FormPrincipal();
        
        public FormAdministradorUsuarios()
        {
            InitializeComponent();
        }
        ...
        private void FormAGREGARUSUARIO_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                connFakeSteamBD.Conectar();
                cmbPAIS.DisplayMember = "NOMBRE";
                cmbPAIS.DataSource = connFakeSteamBD.EjecutarConsulta(new SqlCommand("SELECT NOMBRE FROM PAIS"));
                connFakeSteamBD.CerrarConexion();
            }
            catch (Exception EX)
            {
                MessageBox.Show(EX.Message);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                cmbESTADO.DataSource = connFakeSteamBD.EjecutarConsulta(new SqlCommand(cadena));
                connFakeSteamBD.CerrarConexion();
                timer2.Start();
            }
            catch (Exception EX)
        ...
        private void btnAGREGARUSUARIO_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                connFakeSteamBD.AbrirConexion();
                connFakeSteamBD.EjecutarComando(comando);
                connFakeSteamBD.CerrarConexion();
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                cmbCIUDAD.DataSource = connFakeSteamBD.EjecutarConsulta(new SqlCommand(cadena));
                connFakeSteamBD.CerrarConexion();
            }
            catch (Exception ex)
            {
        ...
        private void tmrEliminar_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                cmbPerfiles.DataSource = connFakeSteamBD.EjecutarConsulta(new SqlCommand(cadena));
                connFakeSteamBD.CerrarConexion();
        ...
        private void btnBuscarDatos_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                NUEVO = connFakeSteamBD.EjecutarConsulta(new SqlCommand(cadena));
                connFakeSteamBD.CerrarConexion();
        ...
        private void tmrActualizar_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                cmbSeleccionarUsuario.DataSource = connFakeSteamBD.EjecutarConsulta(new SqlCommand(cadena));
                connFakeSteamBD.CerrarConexion();
            }
            catch (Exception EX)
            {
        ...
        {
            grpUbicacion.Visible = !grpUbicacion.Visible;
        }
